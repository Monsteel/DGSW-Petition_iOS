//
//  AwaitingViewPetitionCell.swift
//  DGSW-Petition_iOS
//
...
class AwaitingViewPetitionCell: UICollectionViewCell {
    static let registerId = "\(AwaitingViewPetitionCell.self)"
    ...
    var delegate: AwaitingViewPetitionCellDelegate? = nil
...
protocol AwaitingViewPetitionCellDelegate {
