//
//  AwaitingViewEmptyPetitionCell.swift
//  DGSW-Petition_iOS
//
...
class AwaitingViewEmptyPetitionCell: UICollectionViewCell {
    static let registerId = "\(AwaitingViewEmptyPetitionCell.self)"
    ...
    var delegate: AwaitingViewEmptyPetitionCellDelegate? = nil
...
protocol AwaitingViewEmptyPetitionCellDelegate {
