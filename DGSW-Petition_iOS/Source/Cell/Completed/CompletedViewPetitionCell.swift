//
//  CompletedViewPetitionCell.swift
//  DGSW-Petition_iOS
//
...
class CompletedViewPetitionCell: UICollectionViewCell {
    static let registerId = "\(CompletedViewPetitionCell.self)"
    ...
    var delegate: CompletedViewPetitionCellDelegate? = nil
...
protocol CompletedViewPetitionCellDelegate {
