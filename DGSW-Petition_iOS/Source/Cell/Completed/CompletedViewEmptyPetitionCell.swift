//
//  CompletedViewEmptyPetitionCell.swift
//  DGSW-Petition_iOS
//
...
class CompletedViewEmptyPetitionCell: UICollectionViewCell {
    static let registerId = "\(CompletedViewEmptyPetitionCell.self)"
    ...
    var delegate: CompletedViewEmptyPetitionCellDelegate? = nil
...
protocol CompletedViewEmptyPetitionCellDelegate {
