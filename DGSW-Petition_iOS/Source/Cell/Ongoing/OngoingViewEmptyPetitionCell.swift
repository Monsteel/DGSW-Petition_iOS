//
//  OngoingViewEmptyPetitionCell.swift
//  DGSW-Petition_iOS
//
...
class OngoingViewEmptyPetitionCell: UICollectionViewCell {
    ...
    var delegate: OngoingViewEmptyPetitionCellDelegate? = nil
...
protocol OngoingViewEmptyPetitionCellDelegate {
